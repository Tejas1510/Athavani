...
function Profile() {
  ...
  async function save() {
    ...
    try {
      ...
      const { data } = await api.updateProfileById(id, {
        name: newName,
        bio: newBio,
        img: newProfile,
      });
  ...
  return (
    <div className={styles.Profile}>
      ...
      {editMode ? (
        <>
          <LightTooltip title="Save" placement="bottom" arrow>
            <Button
              aria-controls="simple-menu"
              aria-haspopup="true"
          ...
          <LightTooltip title="Close" placement="bottom" arrow>
            <Button
              aria-controls="simple-menu"
              aria-haspopup="true"
        ...
        <LightTooltip title="Edit" placement="bottom" arrow>
          <Button
            aria-controls="simple-menu"
            aria-haspopup="true"
      ...
      <div className={styles.photo}>
        {editMode ? (
          ...
          <img src={img} alt="Not Found" className={styles.profile_img} />
        )}
      </div>
      ...
      <div className={styles.joined}>Joined {moment(joined).fromNow()}</div>
      ...
      <div className={styles.posts_title}>My Posts</div>
      {loading ? (
        <div>
          <CircularProgress />
        </div>
        ...
        <>
          {posts.length === 0 ? (
            ...
            >
              {posts
                .reverse()
                .filter(post => post.creator._id === id)
                .map(post => (
